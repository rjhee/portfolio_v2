...
const NavMenu = (props) => {
    ...
    return (
            <div className={`${display} z-20 fixed top-0 left-0 w-full h-full bg-black bg-opacity-50`}>
                <div className={`animate-[${animate}_500ms_ease-in_1] flex flex-col items-center p-4 drop-shadow-md w-80 h-full bg-slate-200 drop-shadow-md`}>
